...
class Berita_model extends CI_Model {
	...
	//Listing
	public function listing($limit = null, $start = null) {
		$this->db->select('berita.*, LEFT(berita.keterangan , 300) isi_berita, kategori_berita.nama_kategori_berita, users.nama');
		$this->db->from('berita');
		// Join
	...
	public function recent_list($limit, $order) {
		$this->db->select('berita.*, LEFT(berita.keterangan , 250) isi_berita, kategori_berita.nama_kategori_berita, users.nama');
		$this->db->from('berita');
		// Join
		$this->db->join('kategori_berita','kategori_berita.id_kategori_berita = berita.id_kategori_berita', 'LEFT');
		$this->db->join('users','users.id_user = berita.id_user','LEFT');
