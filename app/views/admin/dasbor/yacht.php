...
<form action="<?php echo base_url('admin/dasbor/yacht') ?>" method="post" enctype="multipart/form-data">
	<input type="hidden" name="id_konfigurasi" value="<?php echo $site['id_konfigurasi'] ?>">
	
    <div class="col-md-12">
    <div class="form-group">
    <label>Yacht Information</label>
    <textarea name="yacht" class="form-control" placeholder="Yacht information" id="isi"><?php echo $site['yacht'] ?></textarea>
    </div>
    </div>
