...
<div class="text-box" >
    ...
    <p class="text-muted"><a href="<?php echo base_url('admin/produk') ?>">Grafik</a></p>
</div>
</div>
</div>
...
<div class="text-box" >
    ...
    <p class="text-muted"><a href="<?php echo base_url('admin/kategori_produk') ?>">Kategori Grafik</a></p>
</div>
</div>
</div>
