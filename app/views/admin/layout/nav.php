...
<ul class="nav" id="main-menu">
    ...
    <!-- Dasbor --> 
    <li><a href="<?php echo base_url('admin/dasbor') ?>"><i class="fa fa-dashboard"></i> Admin Panel</a></li>       
    
    <!-- Produk -->           
   <li><a href="#"><i class="fa fa-book"></i>Grafik<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/produk')?>">Data Grafik</a></li>
            <li><a href="<?php echo base_url('admin/produk/tambah')?>">Tambah Grafik</a></li>
            <li><a href="<?php echo base_url('admin/kategori_produk')?>">Kategori Grafik</a></li>
        </ul>
    </li> 
